 ...
 * Generated at: 2023-05-22 09:24:15 UTC
...
public final class Ex04_005fScope_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	<p>※Request (요청이 들어왔을때, Forward(페이지 요청)시에 딱 한번만 데이터를 유지함. URL=>Servlet, Servlet=>URK)</p>\r\n");
      out.write("	<p>※Session (브라우저 내에서는 계속해서 유지되는 정보, 주로 로그인 정보나 상태 정보등으로 건수가 많은 데이터가 아닌 경우)</p>\r\n");
      out.write("	<p>ApplicationContext (어플리케이션이 완전히 종료되지 않는한 계속해서 유지됨 -> 버전 정보, 특정한 업데이트를 위한값 외에는 저장x)</p>\r\n");
      out.write("	");
