...
<body>
	<header>
		<div class="inner">
			...
			<ul id="gnb">
				<li><a href="#">JSTL(TEST_DB)</a></li>
				<li><a href="#">사원목록</a></li>
				<li><a href="#">고객관리</a></li>
				<li><a href="#">내이니셜</a></li>
				<!--list.kgh을 요청하면 요청을 받을수있는 Controller를 추가한다.
					list.kgh가 아닌 요청을 하면 콘솔창에 잘못된 요청이라는 글자가 찍힌다.
					list.kgh가 요청되면 field를 두개가진 DTO를 ArrayList로 만들고 =>list.kgh에서는 
					kgh.list.jsp <=이파일이 실행되고
					el과 jstl을 사용해서 보여준다.
					  -->
				<li><a href="MybatisController2.bac">mybatis2</a></li>
			</ul>
